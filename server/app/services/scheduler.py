...
async def rescan_videos_task(video_urls: list, batch_id: str):
    ...
    try:
        ...
        if not raw_items:
            print("WARNING: Rescan: No new data for comparison.")
            return
        ...
        for item in raw_items:
            ...
            if video:
                ...
                # --- COMPARISON: New data vs Temporary old data (Point A) ---
                history_data = {
        ...
        db.commit()
        print(f"[AUTO-RESCAN] Rescan completed. Stats and UTS scores updated.")
