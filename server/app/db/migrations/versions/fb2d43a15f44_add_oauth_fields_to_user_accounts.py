...
def upgrade() -> None:
    ...
    op.add_column('chat_messages', sa.Column('session_id', sa.String(length=100), nullable=False))
    ...
    op.add_column('user_scripts', sa.Column('hook', sa.Text(), nullable=False))
    op.add_column('user_scripts', sa.Column('body', postgresql.JSONB(astext_type=sa.Text()), nullable=False))
    ...
    op.add_column('user_scripts', sa.Column('duration_seconds', sa.Integer(), nullable=False))
    op.add_column('user_scripts', sa.Column('model_used', sa.String(length=50), nullable=False))
    op.add_column('user_scripts', sa.Column('viral_elements', postgresql.JSONB(astext_type=sa.Text()), nullable=False))
    op.add_column('user_scripts', sa.Column('tips', postgresql.JSONB(astext_type=sa.Text()), nullable=False))
    op.add_column('user_scripts', sa.Column('is_favorite', sa.Boolean(), nullable=False))
    ...
    op.add_column('user_searches', sa.Column('mode', sa.Enum('KEYWORDS', 'USERNAME', name='searchmode'), nullable=False))
    op.add_column('user_searches', sa.Column('is_deep', sa.Boolean(), nullable=False))
